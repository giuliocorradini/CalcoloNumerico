...
Recuperiamo la disuguaglianza che adesso scriviamo come $||y||_2 \gt 0$, allora $y_i = 0 \forall i$. Allora mi trovo
che $A^t = A$ quindi dimostrazione chiusa.
...
$$\mathcal{L}_{jk} = l_{jk}\sqrt{d_{kk}}$$
