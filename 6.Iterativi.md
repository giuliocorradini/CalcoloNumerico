...
Valuto $r(x^*) = Ax^* - b$, che è il residuo del numero. Più la norma è vicina a 0, più la soluzione è coretta.
...
Si può introdurre un parametro di salvaguardi, per bloccare forzatamente l'esecuzione visto che il rischio di questi
...
è diagonale, triangolare superiore o triangolare inferiore. In questo modo posso sfruttare procedimento a basso costo
